...
bool CDungeonScene2::Init()
{
	...
	MonstersSpawn<CPig>(pLayer, L"Pig", { {837 ,574},{	995, 590}
		,{1128, 587},{1303, 598},{1457 ,595} }, {751, 1920/*1567*/});

	MonstersSpawn<CMushroom>(pLayer, L"Mushroom", { {837 ,574},{	995, 590}
		,{1128, 587},{1303, 598},{1457 ,595} }, { 100, 1920/*1680*/});
	...
	GroundsSetUps(EMapObjType::GROUND, pStageLayer,
		{ {389,911,455}, {470,849,547}, {564,791,641}, 
		{653,730,734} ,{745,671,1596} ,{115,369,604} ,
		{660,312,963} ,{1018,251,1588} });
